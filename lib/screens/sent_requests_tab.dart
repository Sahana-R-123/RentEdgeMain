...
class SentRequestsTab extends StatelessWidget {
  ...
  const SentRequestsTab({required this.currentUserId, super.key});
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
          return const Center(
            child: Text('No sent requests', style: TextStyle(fontSize: 16)),
          );
        }
            ...
            return RequestListItem(
              ...
              onAcceptedRequestTap: data['status'] == 'accepted'
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => RequesterPaymentScreen(
                      requestId: request.id,
